...
export default async function PengumumanDetailPage({ params }: PageProps) {
  ...
  if (!announcement || announcement.status !== 'active') return notFound()

  const typeLabel =
    ANNOUNCEMENT_TYPE_LABELS[announcement.type as keyof typeof ANNOUNCEMENT_TYPE_LABELS] ||
    announcement.type
  const statusLabel =
    ANNOUNCEMENT_STATUS_LABELS[announcement.status as keyof typeof ANNOUNCEMENT_STATUS_LABELS] ||
    announcement.status
  const statusColor =
              ...
              <Card className="border-0 shadow-md">
                ...
                <CardContent>
                  <div className="text-muted-foreground leading-relaxed whitespace-pre-line">
                    {announcement.content || 'Tidak ada konten tersedia.'}
                  </div>
                </CardContent>
              </Card>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50 border">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Klik untuk mengunduh file lampiran</p>
                        </div>
                      </div>
                      <Button asChild>
                        <a
            ...
            <div className="space-y-6">
              ...
              <Card className="border-0 shadow-md">
                ...
                <CardContent className="space-y-3">
                  <div>
                    <p className="text-xs text-muted-foreground">Tanggal Publikasi</p>
                  ...
                  {announcement.expiredAt && (
                    <div>
                      ...
                      <p className="text-sm font-medium flex items-center gap-1">
                        ...
                        {formatDate(announcement.expiredAt)}
                      </p>
                    </div>
                  )}
                  <Separator />
